...
def test_schema_migrations_has_one_row_per_applied_migration(tmp_path: Path):
    ...
    assert [tuple(r) for r in rows] == [
        ...
        (13, "013_proposal_revisions.sql"),
        (14, "014_plan_supersede_forward_link.sql"),
        (15, "015_manual_readiness_raw.sql"),
        (16, "016_review_outcome_relink.sql"),
        (17, "017_running_activity.sql"),
        (18, "018_proposal_canonical_leaf_uniqueness.sql"),
        (19, "019_intent_item.sql"),
        (20, "020_target.sql"),
        (21, "021_data_quality.sql"),
        (22, "022_daily_plan_state_fingerprint.sql"),
        (23, "023_source_row_locator.sql"),
        (24, "024_gym_set_id_with_exercise_slug.sql"),
    ]
...
def test_cli_state_migrate_on_head_db_reports_empty_applied(tmp_path: Path, capsys):
    ...
    assert payload["schema_version_before"] == 24
    assert payload["schema_version_after"] == 24
